...
function ExportPanel({ scanResult, personaResults = [], enrichDone = false, personaDone = false }) {
  ...
  const EXPORTS = [
    { type:'company-updates', icon:'🏢', label:'Company Updates',
      ...
      filename:`UPLOAD-TO-HUBSPOT-companies-${d}.csv` },
    { type:'contact-updates', icon:'👤', label:'Contact Updates',
      ...
      filename:`UPLOAD-TO-HUBSPOT-contacts-${d}.csv` },
    { type:'merge-list', icon:'🔀', label:'Merge List',
      ...
      filename:`REVIEW-merge-list-${d}.csv` },
    { type:'parent-child', icon:'🌳', label:'Parent/Child Associations',
      ...
      filename:`REVIEW-parent-child-${d}.csv` },
    { type:'vendor-list', icon:'🚫', label:'Vendor Review',
      ...
      filename:`REVIEW-vendor-list-${d}.csv` },
    { type:'phase3-full', icon:'📋', label:'Contact Issues (Full List)',
      ...
      filename:`REVIEW-contact-issues-${d}.csv` },
    { type:'email-repair', icon:'📧', label:'Email Repair Targets',
      ...
      filename:`REVIEW-email-repair-${d}.csv` },
    { type:'stale', icon:'🕰', label:'Activity Status',
      ...
      filename:`REVIEW-activity-status-${d}.csv` },
  ]
